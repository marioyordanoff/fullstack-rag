...
const api = axios.create({
    baseURL: 'https://marioyordanoff--rag-backend-endpoint.modal.run/async_chat'
})
...
function QuestionForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        const websocket = new WebSocket('wss://marioyordanoff--rag-backend-endpoint.modal.run/async_chat');
